package com.jamaica.japp.utills;

import android.content.Context;
import android.text.TextUtils;

import com.jamaica.japp.utills.Network.AuthenticationInterceptor;
...
public class UrlController {
    ...
    private static OkHttpClient okHttpClient = new OkHttpClient.Builder()
            ...
            .build();
    private static String Purchase_code = "34d3ffd3-1404-4777-8082-d763aafaa1ac";
    private static String Custom_Security = "34d3ffd3-911-4777-8082-d763aafaa1ac";
    private static String IP_ADDRESS = "https://jappclassifieds.com/";
